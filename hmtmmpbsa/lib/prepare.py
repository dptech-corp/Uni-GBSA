...
parameter =  os.path.dirname(os.path.abspath(__file__)) + '../data/propka.cfg'
...
def pdb2pqr(pdbfile:str, outfile:str, ffout='AMBER'):
    ...
    argsdict = parse_args(
        ...
        output_pqr=outpqr, 
        pH=7.0, 
        parameters=parameter, # '/opt/anaconda3/envs/amber/lib/python3.8/site-packages/propka/propka.cfg', 
        pdb_output=outfile, 
        ph=7.0, 
        pka_method=None, 
        protonate_all=False, 
